...
pixi run python -m multilingual_evaluation_globalmmlulite_multiplechoice --model_id Qwen/Qwen3-8B --quantization_technique Unquantized --lang Unquantized --bit 32 2>&1 | tee 'log-globalmmlulite-qwen-Unquantized'
