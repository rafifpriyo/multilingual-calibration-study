...
def weight_prod_contrastive_postprocess(attributed_matrices, model, corrupt_model):
    ...
    for module_name in attributed_matrices:
        ...
        # except:
        #     print("Print failed")
        attributed_matrices[module_name] = attributed_matrices[module_name] * (model[module_name].to('cpu') - corrupt_model[module_name].to('cpu')) * model[module_name].to('cpu')
        del model[module_name]
        del corrupt_model[module_name]
        # try:
        #     print(
        #         "\nFinal:",
        #         f"{attributed_matrices[module_name].abs().mean()=}", 
