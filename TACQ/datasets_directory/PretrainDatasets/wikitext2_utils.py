...
from gptq.datautils import get_wikitext2
class Wikitext2_Dataset(torchDataset):
    def __init__(
        ...
        train_loader, testenc = get_wikitext2(nsamples=nsamples, seed=seed, seqlen=seqlen, model=tokenizer_name)
        if use_train_split:
