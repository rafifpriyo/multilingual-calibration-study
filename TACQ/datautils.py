...
def get_flores(nsamples, seed, seqlen, model, subset=None):
...
def get_loaders(
    name, nsamples=128, seed=0, seqlen=2048, model='', subset=None
):
    if 'flores' in name:
        ...
        if subset in lang_mapper:
            ...
            raise ValueError(f"Dataset Flores with subset {subset} not found")
