...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "dataset",
        type=str,
        choices=["wikitext2", "ptb", "c4", "mix", "flores"],
    ...
    if args.load_quantized:
        ...
        dataloader, testloader = get_loaders(
            args.dataset,
            subset = map_language_to_iso3(args.dataset_subset),
    ...
    create_repo(output_huggingface_gptq.format(bit=args.low_quant_method, lang=args.dataset_subset), repo_type="model", token=hf_key)
