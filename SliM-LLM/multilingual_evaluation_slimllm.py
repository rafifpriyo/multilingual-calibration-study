...
output_result_slimllm = f"./{evaluation_dataset}_{num_shot}shot_{quantization_technique}_{bit}bit_{lang}_{'think' if enable_thinking else 'nothink'}.pkl"
...
if __name__ == '__main__':
    ...
    with wandb.init(
        ...
        artifact.add_file(local_path=f"./{output_result_slimllm}", name=f"{wandb_runname}-result.json")
        artifact.save()
